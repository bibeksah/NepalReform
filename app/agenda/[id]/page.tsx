              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="rounded-2xl border border-violet-200 bg-violet-50/70 p-4 text-sm text-slate-700">
                  ...
                  {item.promiseSourceQuote ? (
                    <blockquote className="mt-3 rounded-xl border-l-4 border-violet-300 bg-white/80 px-4 py-3 italic text-slate-700">&ldquo;{item.promiseSourceQuote}&rdquo;</blockquote>
                  ) : (
